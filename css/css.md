...
# 14.修改:root中--xxx的值,或者往styleSheets中插入新的css
...
## 往styleSheets中插入新的css

```js
let styleSheet = document.styleSheets[0];//选择第一个styleSheet
let newRule = `:root { --test_height:444rem;--test_color:#456 }`;//任何想插入的css
